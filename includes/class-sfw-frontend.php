...
class SFW_Frontend {
    ...
    public function enqueue_assets() {
        ...
        // Enqueue JS (if needed for tracking or advanced interaction)
        wp_enqueue_script( 
            'sfw-script', 
    ...
    public function render_button() {
        ...
        echo sprintf(
            '<div class="sfw-wrapper %s">
                <a href="https://wa.me/%s" class="sfw-button" target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp">
